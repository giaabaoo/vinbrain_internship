...
class PolypPVT(nn.Module):
    def __init__(self, channel=32, num_classes=3):
        super(PolypPVT, self).__init__()

        self.backbone = pvt_v2_b2()  # [64, 128, 320, 512]
        path = '/home/dhgbao/VinBrain/assignments/vinbrain_internship/NeoPolyp/networks/polyp_pvt/pvt_v2_b2.pth'
        ...
        self.out_SAM = nn.Conv2d(channel, num_classes, 1) # BAO, originally, num_classes=1
...
if __name__ == '__main__':
    model = PolypPVT(num_classes=3).cuda()
