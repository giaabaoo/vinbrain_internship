...
class FocalNet(nn.Module):
    ...
    def __init__(self, 
        ...
        self.output = nn.Conv2d(in_channels=self.embed_dim[0], out_channels=3, kernel_size=7, padding=3, bias=False) # BAO: out_channels = 9 originally
